...
#include <memory>
#include "../../../Headers/LoginWindow/loginwindow.h"
...
QT_MOC_LITERAL(3, 21, 9), // "EnterType"
QT_MOC_LITERAL(4, 31, 9), // "enterType"
QT_MOC_LITERAL(5, 41, 5) // "enter"

    },
    "LoginWindow\0entered\0\0EnterType\0enterType\0"
    "enter"
};
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->entered((*reinterpret_cast< EnterType(*)>(_a[1]))); break;
        ...
        {
            using _t = void (LoginWindow::*)(EnterType );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWindow::entered)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginWindow::entered(EnterType _t1)
{
